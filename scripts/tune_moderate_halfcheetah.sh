#!/bin/bash
# Hyperparameter tuning for HALFCHEETAH - MODERATE drift
...
python scripts/tune_hyperparameters.py \
    --env "HalfCheetah-v4" \
    --config "configs/PPO/moderate/half cheetah_friction_sine_baseline_ppo.yaml" \
    --type moderate \
    --n-trials 5 \
    --n-jobs 1 \
    --quick \
    --study-name "moderate_halfcheetah_validation"
...
python scripts/tune_hyperparameters.py \
    ...
    --n-trials 50 \
    --n-jobs 4 \
    --study-name "moderate_halfcheetah_full"

echo ""
echo "================================================================"
echo "✅ Tuning complete!"
echo "================================================================"
echo "Results saved to: results/tuned_params/moderate_halfcheetah_full_best_params.yaml"
echo ""
echo "View dashboard with:"
echo "  optuna-dashboard results/optuna_studies/moderate_halfcheetah_full.db"
echo "================================================================"
