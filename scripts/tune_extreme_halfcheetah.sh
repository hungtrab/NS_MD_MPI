#!/bin/bash
# Hyperparameter tuning for HALFCHEETAH - EXTREME drift
...
python scripts/tune_hyperparameters.py \
    --env "HalfCheetah-v4" \
    --config "configs/PPO/extreme/half cheetah_friction_jump_baseline_ppo.yaml" \
    --type extreme \
    --n-trials 5 \
    --n-jobs 1 \
    --quick \
    --study-name "extreme_halfcheetah_validation"
...
python scripts/tune_hyperparameters.py \
    ...
    --n-trials 50 \
    --n-jobs 4 \
    --study-name "extreme_halfcheetah_full"

echo ""
echo "================================================================"
echo "✅ Tuning complete!"
echo "================================================================"
echo "Results saved to: results/tuned_params/extreme_halfcheetah_full_best_params.yaml"
echo ""
echo "View dashboard with:"
echo "  optuna-dashboard results/optuna_studies/extreme_halfcheetah_full.db"
echo "================================================================"
