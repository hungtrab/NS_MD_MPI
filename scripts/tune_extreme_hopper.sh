#!/bin/bash
# Hyperparameter tuning for HOPPER - EXTREME drift
...
python scripts/tune_hyperparameters.py \
    ...
    --n-jobs 1 \
    --quick \
    --study-name "extreme_hopper_validation"
...
python scripts/tune_hyperparameters.py \
    ...
    --n-trials 50 \
    --n-jobs 4 \
    --study-name "extreme_hopper_full"

echo ""
echo "================================================================"
echo "✅ Tuning complete!"
echo "================================================================"
echo "Results saved to: results/tuned_params/extreme_hopper_full_best_params.yaml"
echo ""
echo "View dashboard with:"
echo "  optuna-dashboard results/optuna_studies/extreme_hopper_full.db"
echo "================================================================"
