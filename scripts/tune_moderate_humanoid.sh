#!/bin/bash
# Hyperparameter tuning for HUMANOID - MODERATE drift

echo "================================================================"
echo "  NS-MDMPI Hyperparameter Tuning - MODERATE DRIFT"
echo "  Environment: Humanoid-v4"
echo "================================================================"
echo ""
...
python scripts/tune_hyperparameters.py \
    --env "Humanoid-v4" \
    --config "configs/PPO/moderate/humanoid_friction_sine_baseline_ppo.yaml" \
    --type moderate \
    --n-trials 5 \
    --n-jobs 1 \
    --quick \
    --study-name "moderate_humanoid_validation"
...
python scripts/tune_hyperparameters.py \
    ...
    --n-trials 50 \
    --n-jobs 4 \
    --study-name "moderate_humanoid_full"

echo ""
echo "================================================================"
echo "✅ Tuning complete!"
echo "================================================================"
echo "Results saved to: results/tuned_params/moderate_humanoid_full_best_params.yaml"
echo ""
echo "View dashboard with:"
echo "  optuna-dashboard results/optuna_studies/moderate_humanoid_full.db"
echo "================================================================"
