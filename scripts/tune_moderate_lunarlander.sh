#!/bin/bash
# Hyperparameter tuning for LUNARLANDER - MODERATE drift
...
python scripts/tune_hyperparameters.py \
    --env "LunarLander-v2" \
    --config "configs/PPO/moderate/lunarlander_gravity_sine_baseline_ppo.yaml" \
    --type moderate \
    --n-trials 5 \
    --n-jobs 1 \
    --quick \
    --study-name "moderate_lunarlander_validation"
...
python scripts/tune_hyperparameters.py \
    ...
    --n-trials 50 \
    --n-jobs 4 \
    --study-name "moderate_lunarlander_full"

echo ""
echo "================================================================"
echo "✅ Tuning complete!"
echo "================================================================"
echo "Results saved to: results/tuned_params/moderate_lunarlander_full_best_params.yaml"
echo ""
echo "View dashboard with:"
echo "  optuna-dashboard results/optuna_studies/moderate_lunarlander_full.db"
echo "================================================================"
